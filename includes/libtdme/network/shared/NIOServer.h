/**
 * @version $Id: 6f96d2b25cfb052b2e9f2b173ed743348e766b49 $
 */

#ifndef TDME_NETWORK_NIOSERVER
#define TDME_NETWORK_NIOSERVER
...
s			 * @param max ccu
		...
		protected:
			...
			TDMEThreading::ReadWriteLock clientKeyListsReadWriteLock;

			GroupKeyMap groupKeyMap;
			GroupKeySet groupKeySet;

			TDMEThreading::ReadWriteLock groupKeyListsReadWriteLock;
